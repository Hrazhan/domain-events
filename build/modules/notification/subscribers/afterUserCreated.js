...
var DomainEvents_1 = require("../../../core/domain/event/DomainEvents");
var UserCreated_1 = require("../../users/domain/events/UserCreated");
var AfterUserCreated = /** @class */ (function () {
    ...
    AfterUserCreated.prototype.setupSubscription = function () {
        DomainEvents_1.DomainEvents.register(this.onUserCreatedEvent.bind(this), UserCreated_1.UserCreated.name);
    };
    AfterUserCreated.prototype.onUserCreatedEvent = function (event) {
